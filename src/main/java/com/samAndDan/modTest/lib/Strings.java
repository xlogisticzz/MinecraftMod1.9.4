...
public class Strings {
    ...
    public static final String COMMONPROXY = "com.samAndDan.modTest.proxies.CommonProxy";
    public static final String GUIFACTORY = "com.samAndDan.modTest.config.GuiFactory";
